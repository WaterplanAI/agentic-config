...
uv run .claude/skills/mux/tools/signal.py "$SESSION_DIR/.signals/001-research.done" \
...
uv run .claude/skills/mux/tools/signal.py "$SESSION_DIR/.signals/001-research.fail" \
    --path "$SESSION_DIR/research/001-topic.md" \
    --status fail \
