...
# ///
"""
OSpec v2 tool: thin wrapper around spawn.py for the /mux-ospec workflow.
...
Usage:
    uv run core/tools/agentic/ospec_v2.py full specs/2026/02/branch/001-feature.md
    uv run core/tools/agentic/ospec_v2.py lean specs/2026/02/branch/001-feature.md --extra-context "auth module"
    uv run core/tools/agentic/ospec_v2.py leanest specs/2026/02/branch/001-feature.md --model medium-tier
    uv run core/tools/agentic/ospec_v2.py full specs/001.md --max-depth 3
...
def build_parser() -> argparse.ArgumentParser:
    """Build argument parser for ospec v2 tool."""
...
def main() -> int:
    """Run the ospec v2 workflow by delegating to spawn.py."""
    parser = build_parser()
