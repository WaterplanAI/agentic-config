...
```bash
# Read document
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py read <doc_id>

# Read specific tab
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py read <doc_id> --tab "Tab Name"

# Write text (insert at index)
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py write <doc_id> "Text to insert"

# Write markdown with tables
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py write <doc_id> "# Heading" --markdown

# Append to document
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py write <doc_id> "Appended text" --append

# Create new document
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py create "Document Title"

# Export to PDF
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py export <doc_id> -o output.pdf

# List tabs
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py tabs <doc_id>

# Create tab
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py create-tab <doc_id> "New Tab"

# Rename tab
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py rename-tab <doc_id> <tab_id> "New Name"

# Delete tab
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py delete-tab <doc_id> <tab_id> --yes
```
