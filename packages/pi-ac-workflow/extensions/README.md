...
- `pimux/`
  ...
  - authoritative runtime for generated mux-family skills (`ac-workflow-mux`, `ac-workflow-mux-ospec`, `ac-workflow-mux-roadmap`) and thin package aliases (`pimux`, `mux`, `mux-ospec`, `mux-roadmap`)
...
For the user-facing topology guide and naming contract (`ac-workflow-*` canonical IDs with `mux*` trigger aliases, runtime-only `pimux` plus a thin `pimux` trigger shim), see [../README.md](../README.md) and [../../../docs/pimux-workflow-topologies.md](../../../docs/pimux-workflow-topologies.md).
