---
name: ac-git-gh-assets-branch-mgmt
...
```bash
/skill:ac-git-gh-assets-branch-mgmt init
```
...
```bash
/skill:ac-git-gh-assets-branch-mgmt upload outputs/screenshots/*.png --context pr-42
```
...
```bash
/skill:ac-git-gh-assets-branch-mgmt url screenshot.png --context pr-42
```
...
```bash
/skill:ac-git-gh-assets-branch-mgmt upload ./recording.mov --context pr-42
```
...
```bash
/skill:ac-git-gh-assets-branch-mgmt convert-video ./demo.mov --preset pr-medium
```
...
```bash
/skill:ac-git-gh-assets-branch-mgmt download-video pr-42
```
...
```bash
/skill:ac-git-gh-assets-branch-mgmt cleanup --context pr-42
```
