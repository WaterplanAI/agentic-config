...
```bash
# Check status
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/auth.py status --json

# Add account (opens browser for OAuth)
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/auth.py add

# Switch active account
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/auth.py switch <email>

# Remove account
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/auth.py remove <email>
```
...
6. **Authenticate**: `uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/auth.py add`

7. **Verify**: `uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/setup.py check`
...
3. After key placed: `uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/auth.py status`
...
3. Retry: `uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/auth.py add`
