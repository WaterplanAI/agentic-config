...
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/mermaid.py render "graph TD; A-->B" -o diagram.png

# Render from file
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/mermaid.py render @flowchart.mmd -o output.png

# Render as SVG
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/mermaid.py render "graph TD; A-->B" -f svg

# Upload to Drive (private)
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/mermaid.py upload "graph TD; A-->B" --name architecture.png

# Upload to specific folder
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/mermaid.py upload @diagram.mmd --folder <folder_id> --name flow.png

# Generate URL only (no upload)
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/mermaid.py url "graph TD; A-->B"
```
