...
Execute:
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py write {DOC_ID} "{TEXT}" --append
```
...
Execute:
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py write {DOC_ID} "{TEXT}" --index {INDEX}
```
...
Execute:
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py create "{TITLE}" --json
```
...
Execute:
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/docs.py export {DOC_ID} --format pdf --output {OUTPUT_PATH}
```
