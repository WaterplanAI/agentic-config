...
Execute:
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/sheets.py write {SPREADSHEET_ID} "{CELL}" "{VALUE}"
```
...
Execute:
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/sheets.py write {SPREADSHEET_ID} "{RANGE}" '[{VALUES}]'
```
...
Execute:
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/sheets.py append {SPREADSHEET_ID} "{SHEET_NAME}" '[{VALUES}]'
```
...
Execute:
uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/sheets.py create "{TITLE}" --json
```
