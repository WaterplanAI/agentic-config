...
class TestValidateL2OspecConfig:
    def test_valid_config(self) -> None:
        config = {
            "executor": "${CLAUDE_PLUGIN_ROOT}/scripts/tools/spec.py",
            "modifier": "full",
            "stages": [
                {
                    "name": "RESEARCH",
...
class TestValidateL2OresearchConfig:
    def test_valid_config(self) -> None:
        config = {
            "executor": "${CLAUDE_PLUGIN_ROOT}/scripts/tools/researcher.py",
            "workers": [
                {
                    "domain": "market",
                    "model": "medium-tier",
            ...
            "phases": [
                {
                    ...
                    "orchestrator": "${CLAUDE_PLUGIN_ROOT}/scripts/tools/ospec.py",
                    "modifier": "full",
