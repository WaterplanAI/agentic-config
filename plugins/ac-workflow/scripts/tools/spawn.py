...
Usage:
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/spawn.py --prompt "Do X" --model medium-tier
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/spawn.py --prompt "Do X" --system-prompt agents/researcher.md
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/spawn.py --prompt "Do X" --allowed-tools "Bash,Read,Grep,Glob"
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/spawn.py --prompt "Do X" --output-format json
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/spawn.py --prompt "Do X" --max-depth 3 --current-depth 1
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/spawn.py --prompt "Do X" --cwd /path/to/project
