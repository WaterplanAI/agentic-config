...
ORESEARCH_SCRIPT_RELATIVE = Path("scripts", "tools", "oresearch.py")
COORDINATOR_SCRIPT_RELATIVE = Path("scripts", "tools", "coordinator.py")
SPAWN_SCRIPT_RELATIVE = Path("scripts", "tools", "spawn.py")

REFINEMENT_PROMPT_RELATIVE = Path("scripts", "prompts", "campaigns", "refinement-evaluator.md")
ROADMAP_PROMPT_RELATIVE = Path("scripts", "prompts", "campaigns", "roadmap-writer.md")
EVALUATOR_PROMPT_RELATIVE = Path("scripts", "prompts", "campaigns", "evaluator.md")
TEMPLATES_DIR_RELATIVE = Path("scripts", "tools", "config", "templates")
...
def run_decompose(
    ...
    prompt = (
        ...
        f'"phases": ['
        f'{{"name": "phase-01-...", "orchestrator": "scripts/tools/ospec.py", '
