...
├──────────────────────────────────┤    ├──────────────────────────────┤
│ File: tmp/mux-session/.signals│    │ File: tmp/mux-session/.signals
│        /worker-dir-analyzer-001  │    │        /worker-file-scanner-002
│        .done                     │    │        .done                 │
├──────────────────────────────────┤    ├──────────────────────────────┤
│ Content:                         │    │ Content:                     │
...
│  ├─ tmp/mux-session/.signals/worker-dir-analyzer-001.done       │
│  └─ tmp/mux-session/.signals/worker-file-scanner-002.done       │
│                                                                      │
│  Combine metrics:                                                   │
...
│      Status: COMPLETED                                         │
│      Signal file: tmp/mux-session/.signals/                │
