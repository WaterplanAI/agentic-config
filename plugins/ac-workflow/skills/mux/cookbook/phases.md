...
Task(
    prompt="""Read ${CLAUDE_PLUGIN_ROOT}/skills/mux/agents/auditor.md for protocol.
...
Same pattern as Phase 2, using `${CLAUDE_PLUGIN_ROOT}/skills/mux/agents/auditor.md`.

```python
# Workers
for audit_task in audit_tasks:
    Task(
        prompt=f"""Read ${CLAUDE_PLUGIN_ROOT}/skills/mux/agents/auditor.md for protocol.
...
```python
Task(
    prompt=f"""Read ${CLAUDE_PLUGIN_ROOT}/skills/mux/agents/consolidator.md for protocol.
...
```python
Task(
    prompt=f"""Read ${CLAUDE_PLUGIN_ROOT}/skills/mux/agents/coordinator.md for protocol.
...
```python
Task(
    prompt=f"""Read ${CLAUDE_PLUGIN_ROOT}/skills/mux/agents/writer.md for protocol.
...
```python
Task(
    prompt=f"""Read ${CLAUDE_PLUGIN_ROOT}/skills/mux/agents/sentinel.md for protocol.
